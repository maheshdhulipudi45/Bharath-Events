...
import { Users, Wind, UtensilsCrossed, BedDouble, Car, Zap, Flower2, MapPin } from "lucide-react";
      ...
      <section className="section-padding">
        <div className="container mx-auto">
          ...
          <SectionHeading
            ...
            subtitle="Sri Manikyamba Kalyana Mandapam"
          />
            ...
            <div>
              <div className="flex flex-wrap gap-3 mb-6">
                {serviceLocations.map((loc) => (
                  <span key={loc} className="inline-flex items-center gap-2 px-4 py-2 bg-secondary rounded-xl text-sm font-medium">
              ...
              <p className="text-muted-foreground text-sm">
                Sri Manikyamba Kalyana Mandapam located at Pasuvullanka near Amalapuram.
                It is a spacious wedding venue with excellent facilities and serves
                Muramalla and surrounding villages.
              </p>
